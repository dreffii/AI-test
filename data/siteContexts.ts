...
export const siteContextThumbnails: { [key in typeof siteContextOpts[number]]: string } = 
    Object.fromEntries(
        siteContextOpts.map(opt => [opt, `https://picsum.photos/seed/${slugify(opt)}/200/150`])
    ) as { [key in typeof siteContextOpts[number]]: string };
